...
class RNN(nn.Module):
    def __init__(self):
        ...
        #주가를 예측하는 MLP 층 정의
        self.fc1 = nn.Linear(in_features=240, out_features=8)
...
torch.save(model.state_dict(), "./rnn8.pth")
'''
...
with torch.no_grad():
    model.load_state_dict(torch.load("rnn8.pth", map_location=device))
    ...
    for data, label in loader:
        ...
        total_loss8 += loss/len(loader)


print("배치사이즈 8 일 때:",total_loss8.item())
