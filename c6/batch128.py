...
torch.save(model.state_dict(), "./rnn128.pth")
'''
...
with torch.no_grad():
    model.load_state_dict(torch.load("rnn128.pth", map_location=device))
    ...
    for data, label in loader:
        ...
        total_loss128 += loss/len(loader)


print("배치사이즈 128 일 때:",total_loss128.item())
